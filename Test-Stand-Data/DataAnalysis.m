...
allCoeff = [coefficients1; coefficients2; coefficients3; coefficients4; coefficients5];

totalCoeff1 = 0;
for i = 1:length(allCoeff)
    totalCoeff1 = totalCoeff1 + allCoeff(i,1);
end
avgCoeff1 = totalCoeff1/length(allCoeff);

totalCoeff2 = 0;
for i = 1:length(allCoeff)
    totalCoeff2 = totalCoeff2 + allCoeff(i,2);
end
avgCoeff2 = totalCoeff2/length(allCoeff);
